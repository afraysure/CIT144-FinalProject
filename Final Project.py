...
class MainProgram:
        ...
        def __init__(self):
                ...
                Entry(window, textvariable = self.lastname, justify = LEFT).grid(row = 1, column = 5, columnspan = 2, sticky = W)
                ...
                label = Label(window, text = "City", width = 7, justify = RIGHT).grid(row = 3, column = 1)
                ...
                label = Label(window, text = "State", width = 5, justify = RIGHT).grid(row = 3, column = 3)
                ...
                label = Label(window, text = "Zip Code", width = 8, justify = RIGHT).grid(row = 3, column = 5)
                ...
                label = Label(window, text = "Comments", width = 8, justify = CENTER).grid(row = 4, column = 1, columnspan = 6)
                #entry box for guests zip code
